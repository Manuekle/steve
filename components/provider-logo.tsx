...
// Vendor marks for the three model routes.
//
...
//
// All three are single-color and inherit `currentColor`, so a row of them
// reads as one set and follows the theme instead of fighting it.

export type ProviderMark = "openai" | "anthropic" | "gateway";
...
/** The mark ships as `fill="#ffff"` (opaque white), which disappears on a
 *  light background. `currentColor` makes it follow the theme like the other
 *  two marks. */
