...
export const CodeBlockContainer = ({
  ...
  <div
    className={cn(
      "group relative w-full overflow-hidden rounded-xl border border-border bg-card text-foreground shadow-[var(--shadow-soft)]",
      className,
    )}
...
export const CodeBlockHeader = ({
  ...
  <div
    className={cn(
      "flex items-center justify-between border-b border-border bg-muted/60 px-3.5 py-2.5 text-xs text-muted-foreground",
      className,
    )}
    {...props}
  >
