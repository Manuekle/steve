...
const STATUS_KEYS: Record<ApprovalCardStatus, string> = {
  submitting: "approval.submitting",
  approved: "approval.approved",
  rejected: "approval.rejected",
  "changes-requested": "approval.changesRequested",
...
export function ApprovalCard({
  ...
  const approve = approveLabel ?? t("approval.approve");
  const submit = submitLabel ?? t("approval.submit");
