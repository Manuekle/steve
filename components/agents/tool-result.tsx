...
function getStatusKey(status: ToolResultStatus) {
  if (status === "running") return "chat.toolRunning";
  if (status === "success") return "chat.toolCompleted";
  if (status === "error") return "chat.toolFailed";
  return "chat.toolCancelled";
}
        ...
        <div className="pl-6 pt-1.5">
          ...
          >
            ...
            {canCopy || onRetry ? (
              ...
              {canCopy ? (
                <ToolResultAction
                  label={copied ? t("chat.copied") : t("chat.copyResult")}
                  onClick={handleCopy}
                >
                  {copied ? (
              ...
              {onRetry ? (
                <ToolResultAction label={t("chat.runAgain")} onClick={onRetry}>
