...
/** The orb verb that matches the label above, one row for one row. */
function getActiveOrb(type: AgentActivityContentType): OrbState {
  if (type === "search") return "searching";
  if (type === "tool") return "working";
  if (type === "trace") return "solving";
  if (type === "mixed") return "working";
  return "breathing";
}
        ...
        >
          {renderWorkingStatus ? (
            ...
            <span className="flex items-center gap-2">
              <Orb state={getActiveOrb(contentType)} />
