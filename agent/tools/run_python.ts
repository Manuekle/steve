...
export default defineTool({
  description:
    ...
    "stdout, stderr, and exit code. Use this for computation: generating " +
    "data, reading files under /workspace, and computing statistics. Files " +
    "written to /workspace persist across calls within the same session. " +
    "Programs have a 15-second execution limit.",
