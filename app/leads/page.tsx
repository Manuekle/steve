...
import { SearchIcon, Download01Icon, Delete01Icon } from "@hugeicons/core-free-icons";
                      ...
                      {filtered.map((c) => (
                        <tr key={c.id} className="border-b border-border/50 last:border-0 hover:bg-muted/30">
                          ...
                          <td className="px-4 py-2.5 text-right">
                            <button onClick={() => void remove(c.id)} className="inline-flex rounded-md p-1.5 text-muted-foreground hover:bg-destructive/10 hover:text-destructive" aria-label="Eliminar" title="Eliminar">
